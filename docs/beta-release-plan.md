...
- Add a dedicated release-like instrumentation variant if we need to prove release UI behavior on-device rather than through forced-safe composable smoke plus release assembly.
